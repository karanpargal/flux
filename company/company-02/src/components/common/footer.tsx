export default function Footer() {
    ...
    return (
        <footer className="relative bg-dark-950/90 backdrop-blur-md border-t border-retro-500/20">
            {/* Animated background */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-0 left-1/4 w-32 h-32 bg-retro-500/5 rounded-full blur-2xl animate-float-retro"></div>
                <div
                    className="absolute bottom-0 right-1/4 w-48 h-48 bg-cyan-500/5 rounded-full blur-3xl animate-float-retro"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-300 mb-6 max-w-md">
                            Empower business teams without breaking the bank.
                            Build custom internal tools, centralize operations,
