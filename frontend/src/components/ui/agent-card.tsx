...
const AgentCard: React.FC<AgentCardProps> = ({
    ...
    return (
        <div
            className={`bg-white rounded-lg flex flex-col gap-y-4 shadow-md border border-stone-200 py-6 hover:shadow-lg transition-shadow cursor-pointer ${className}`}
            onClick={handleCardClick}
        >
            <div className="flex items-start justify-between border-b border-citrus-95 pb-4">
                <div className="flex-1 px-6">
                    <div className="flex items-center  gap-3 mb-2 ">
                        <h3 className="text-lg font-semibold text-stone-500">
                            {agent.name}{" "}
                            <span className="text-citrus-500">
                                ({agent.ens})
                            </span>
                        </h3>
                        <span
                ...
                <div className="toggle-container px-6">
                    <button
            ...
            <div className="px-6 flex flex-col gap-y-2">
                ...
                <div className="flex items-center  justify-between">
                    <div className="text-xs text-citrus-900">
                        Created:{" "}
