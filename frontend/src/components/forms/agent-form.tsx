...
const AVAILABLE_CAPABILITIES = [
  {
    ...
    description:
      "Search and reference company documents, PDFs, and knowledge base",
    configurable: false,
  },
  {
  ...
  },
  {
    ...
    description:
      "Process refunds and validate refund requests with company-specific limits",
    configurable: true,
    parameters: [
      {
...
const AgentForm: React.FC<AgentFormProps> = ({
  ...
  const handleFiles = useCallback(
    (files: FileList | File[]) => {
      ...
      if (
        newFiles.length > 0 &&
        !enabledCapabilities.has("document_reference")
      ) {
              ...
              >
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    disabled={
                      capability.name === "document_reference" &&
                      uploadedFiles.length > 0
                    }
                  ...
                  <div className="flex-1">
                    ...
                    {enabledCapabilities.has(capability.name) &&
